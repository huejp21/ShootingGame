...
public class MapGenerator : MonoBehaviour {
    ...
    public class Map
    {
        ...
        public Coord mapCenter
        {
            get
            {
                return new Coord((int)(mapSize.x / 2.0f), (int)(mapSize.y / 2.0f));
            }
        }
    }
    ...
    public void GeneratorMap()
    {
        ...
        shuffledTileCoords = new Queue<Coord>(Utility.SuffleArray(allTileCoords.ToArray(), currentMap.seed));

        // Creating map holder object
        string holderName = "Gernerated Map";
        ...
        for (int i = 0; i < obstacleCount; i++)
        {
              ...
              && MapIsFullyAccessible(obstacleMap, currentObstacleCount))
            {
                ...
                Transform newObstacle = Instantiate(obstaclePrefab, obstaclePosition + (Vector3.up * obstacleHeight / 2.0f), Quaternion.identity) as Transform;
        ...
        shuffledOpenTileCoords = new Queue<Coord>(Utility.SuffleArray(allOpenCoords.ToArray(), currentMap.seed));
